...
@WebServlet(name="tableauinfo",
        urlPatterns={"/TableauInfo"})

public class TableauInfo extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try{
            ...
            sql = "SELECT MAX(id) as id FROM Tableau";

            ResultSet rs = stmt.executeQuery(sql);
            while(rs.next()){
                int id  = rs.getInt("id");
                int id2 =id+1;
                stmt.executeUpdate("INSERT INTO `tableau`(`id`, `name`) VALUES ("+id2+",'"+ nombre+"')");
